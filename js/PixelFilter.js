angular
	...
	.controller('PixelFilterController', ['$scope', 'Webworker', function ($scope, Webworker) {
		...
		$scope.Filters = [
			...
			{ name: 'aascale', parameters: [2, 4], description: 'Anti Alias scaler (used in SameBoy emulator)' },
			...
			{ name: 'lcd', parameters: [2], description: 'LCD scaler (used in SameBoy emulator)' },
