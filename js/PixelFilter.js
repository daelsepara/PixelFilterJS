angular
	.module('PixelFilter', ['ngWebworker'])
	.controller('PixelFilterController', ['$scope', 'Webworker', function ($scope, Webworker) {
		...
		$scope.Filters = [
			...
			{ name: 'aascale', parameters: [2, 3, 4, 5, 6, 7, 8, 9, 10], description: 'Anti Alias scaler (used in SameBoy emulator)' },
			{ name: 'advancemame', parameters: [2, 3], description: 'AdvanceMame scaling using interpolation' },
			{ name: 'bead', parameters: [2, 3, 4, 5, 6, 7, 8, 9, 10], description: 'Bead shader' },
			{ name: 'bevel', parameters: [2, 3, 4, 5, 6, 7, 8, 9, 10], description: 'Hyllian\'s Bevel Shader' },
			...
			{ name: 'gbgreen', parameters: [1], description: 'Gameboy Green filter' },
			...
			{ name: 'supergameboy', parameters: [1], description: 'Super Gameboy green filter' },
