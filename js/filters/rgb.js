            ...
            for (var x = 0; x < srcx; x++) {
                ...
                switch(scale) {
                    ...
                    case 2: // x2
                        ...
                        P[1] = Common.RGBINT(Common.Red(pixel), 0, 0);
                        P[2] = Common.RGBINT(0, Common.Green(pixel), 0);
                        P[3] = Common.RGBINT(0, 0, Common.Blue(pixel));
                        P[4] = pixel;
                    ...
                    case 3: // x3
                        ...
                        P[2] = Common.RGBINT(0, Common.Green(pixel), 0);
                        P[3] = Common.RGBINT(0, 0, Common.Blue(pixel));
                        P[4] = Common.RGBINT(0, 0, Common.Blue(pixel));
                        P[5] = pixel;
                        P[6] = Common.RGBINT(Common.Red(pixel), 0, 0);
                        P[7] = Common.RGBINT(Common.Red(pixel), 0, 0);
                        P[8] = Common.RGBINT(0, Common.Green(pixel), 0);
                        P[9] = pixel;
                    ...
                    case 4: // x4
                        ...
                        P[3] = P[4] = P[7] = P[8] = Common.RGBINT(0, Common.Green(pixel), 0);
                        P[9] = P[10] = P[13] = P[14] = Common.RGBINT(0, 0, Common.Blue(pixel));
                        P[11] = P[12] = P[15] = P[16] = Common.RGBINT(Common.Red(pixel), 0, 0);
