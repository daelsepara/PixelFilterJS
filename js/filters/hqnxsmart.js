    ...
    Apply(Input, srcx, srcy, scale, threshold) {
        ...
        for (var y = 0; y < srcy; y++) {
            for (var x = 0; x < srcx; x++) {
                ...
                if (Common.IsLike(c0, c4) || Common.IsLike(c2, c4) || Common.IsLike(c6, c4) || Common.IsLike(c8, c4)) {
                    ...
                    var brightness = [ 
                        Common.Brightness(c0),
                        Common.Brightness(c1),
                        Common.Brightness(c2),
                        Common.Brightness(c3),
                        Common.Brightness(c4),
                        Common.Brightness(c5),
                        Common.Brightness(c6),
                        Common.Brightness(c7),
                    ...
                    var dc4 = Common.Brightness(c4) > avgBrightness;

                    if ((Common.IsNotLike(c4, c0)) && brightness[0] > avgBrightness != dc4)
                        pattern |= 1;
                    if ((Common.IsNotLike(c4, c1)) && brightness[1] > avgBrightness != dc4)
                        pattern |= 2;
                    if ((Common.IsNotLike(c4, c2)) && brightness[2] > avgBrightness != dc4)
                        pattern |= 4;
                    if ((Common.IsNotLike(c4, c3)) && brightness[3] > avgBrightness != dc4)
                        pattern |= 8;
                    if ((Common.IsNotLike(c4, c5)) && brightness[5] > avgBrightness != dc4)
                        pattern |= 16;
                    if ((Common.IsNotLike(c4, c6)) && brightness[6] > avgBrightness != dc4)
                        pattern |= 32;
                    if ((Common.IsNotLike(c4, c7)) && brightness[7] > avgBrightness != dc4)
                        pattern |= 64;
                    if ((Common.IsNotLike(c4, c8)) && brightness[8] > avgBrightness != dc4)
                        pattern |= 128;
                }
