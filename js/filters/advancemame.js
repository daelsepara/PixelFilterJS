                ...
                switch(scale) {
                    ...
                    case 3: // x3
                        ...
                        if (Common.IsNotLike(c1, c7) && Common.IsNotLike(c3, c5)) {
                            ...
                            if (Common.IsLike(c3, c1)) {
                                ...
                                P[1] = Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c3, c1), c4, 5, 3);
                            }
                            
                            if (Common.IsLike(c1, c5)) {

                                P[3] = Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c5, c1), c4, 5, 3);
                            }
                            
                            if (Common.IsLike(c3, c7)) {

                                P[7] = Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c3, c7), c4, 5, 3);
                            }
                            
                            if (Common.IsLike(c7, c5)) {

                                P[9] = Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c7, c5), c4, 5, 3);
                            }
                            ...
                            if ((Common.IsLike(c3, c1) && Common.IsNotLike(c4, c2)) && (Common.IsLike(c5, c1) && Common.IsNotLike(c4, c0)))
                                ...
                                P[2] = Interpolate.Interpolate2PA(c3, c1);
                            ...
                            if ((Common.IsLike(c3, c7) && Common.IsNotLike(c4, c8)) && (Common.IsLike(c5, c7) && Common.IsNotLike(c4, c6)))
                                ...
                                P[8] = Interpolate.Interpolate2PA(c3, c7);
                            else if (Common.IsLike(c5, c7) && Common.IsNotLike(c4, c6))
                                P[8] = Interpolate.Interpolate2PA(c5, c7);
                        }
                    ...
                    default: // x2
                        ...
                        if (Common.IsNotLike(c1, c7) && Common.IsNotLike(c3, c5)) {
                            ...
                            P[1] = (Common.IsLike(c3, c1)) ? Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c1, c3), c4, 5, 3) : c4;
                            P[2] = (Common.IsLike(c5, c1)) ? Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c1, c5), c4, 5, 3) : c4;
                            P[3] = (Common.IsLike(c3, c7)) ? Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c7, c3), c4, 5, 3) : c4;
                            P[3] = (Common.IsLike(c5, c7)) ? Interpolate.Interpolate2P2QA(Interpolate.Interpolate2PA(c7, c5), c4, 5, 3) : c4;
                        }
