                ...
                switch(scale) {
                    ...
                    case 3: // x3
                        ...
                        if (Common.IsNotLike(c1, c7) && Common.IsNotLike(c3, c5)) {
                            ...
                            if (
                                (Common.IsLike(c3, c1) && Common.IsNotLike(c4, c2)) &&
                                (Common.IsLike(c5, c1) && Common.IsNotLike(c4, c0))
                                )
                            ...
                            if (
                                (Common.IsLike(c3, c1) && Common.IsNotLike(c4, c6)) &&
                                (Common.IsLike(c3, c7) && Common.IsNotLike(c4, c0))
                                )
                            ...
                            if (
                                (Common.IsLike(c5, c1) && Common.IsNotLike(c4, c8)) &&
                                (Common.IsLike(c5, c7) && Common.IsNotLike(c4, c2))
                                )
                            ...
                            if (
                                (Common.IsLike(c3, c7) && Common.IsNotLike(c4, c8)) &&
                                (Common.IsLike(c5, c7) && Common.IsNotLike(c4, c6))
                                )
