    ...
    Apply(Input, srcx, srcy, scale, threshold) {
        ...
        for (var y = 0; y < srcy; y++) {
            for (var x = 0; x < srcx; x++) {
                ...
                P[1] = Common.RGBINT(ReverseAA.FullClamp(rr), ReverseAA.FullClamp(gr), ReverseAA.FullClamp(br));
                P[2] = Common.RGBINT(ReverseAA.FullClamp(rg), ReverseAA.FullClamp(gg), ReverseAA.FullClamp(bg));
                P[3] = Common.RGBINT(ReverseAA.FullClamp(rb), ReverseAA.FullClamp(gb), ReverseAA.FullClamp(bb));
                P[4] = Common.RGBINT(ReverseAA.FullClamp(ra), ReverseAA.FullClamp(ga), ReverseAA.FullClamp(ba));
